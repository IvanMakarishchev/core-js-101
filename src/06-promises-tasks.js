...
function willYouMarryMe(isPositiveAnswer) {
  return new Promise((resolve, reject) => (
    (isPositiveAnswer === true && resolve('Hooray!!! She said "Yes"!'))
    || (isPositiveAnswer === false && resolve('Oh no, she said "No".'))
...
async function chainPromises(array, action) {
  const result = [];
  await array.map((el) => el.then((value) => result.push(value)).catch(() => {}));
